...
def combo_changed(cellrenderercombo, path_string, new_iter):    
    liststoreAppliance[path_string][1] = liststoreManufacturers[new_iter][0]
...
liststoreAppliance.append(["Refrigerator", "Bosch"])
